...
function Hack(t, netw)
    ...
    function hackbg:Paint(w, h)
        ...
        drawRotatedBox( "gmtech/skull.png", w/2, h/2, 512, 512, (CurTime() * 36) % 360, Color(5,255,5,100) )

        local remainingTime = string.FormattedTime( timer.TimeLeft("hackingkill"), "%02i:%02i:%02i" )
        draw.SimpleText(remainingTime or 0, "gmt.title.big", w/2, h-55, Color(5,255,5, 100), TEXT_ALIGN_CENTER)
    end
    ...
    timer.Create("changeloop", 1.1, 0, function()
