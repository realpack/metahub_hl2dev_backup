...
serverguard.NotifyColors[SERVERGUARD.NOTIFY.DEFAULT]	= Color(50, 180, 232); -- For backwards compatibility.
serverguard.NotifyColors[SERVERGUARD.NOTIFY.RED] 		= Color(51, 213, 232);
serverguard.NotifyColors[SERVERGUARD.NOTIFY.WHITE] 		= Color(50, 180, 232);
serverguard.NotifyColors[SERVERGUARD.NOTIFY.GREEN]		= Color(51, 213, 232);
