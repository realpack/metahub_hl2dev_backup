...
timer.Simple(.1, function()
	...
	rp.cfg.TeamSpawns = {
		rp_city2_v4_finalb = {
			[TEAM_UN1] = { Vector('-1076.448242 1888.762817 630') },
			[TEAM_UN2] = { Vector('-1076.448242 1888.762817 630') },
			[TEAM_UN3] = { Vector('-958.263611 1908.137817 630') },
			[TEAM_UN4] = { Vector('-958.263611 1908.137817 630') },
			[TEAM_UN5] = { Vector('-867.293457 1826.577637 630') },
			[TEAM_UN6] = { Vector('-867.293457 1826.577637 630') },
			[TEAM_UN7] = { Vector('-1076.448242 1888.762817 630') },
			[TEAM_UN8] = { Vector('-1076.448242 1888.762817 630') },
			[TEAM_S0] = { Vector('-1076.448242 1888.762817 630') },
			[TEAM_S1] = { Vector('-1076.448242 1888.762817 630') },
			[TEAM_S2] = { Vector('-958.263611 1908.137817 630') },
			[TEAM_S3] = { Vector('-958.263611 1908.137817 630') },
			[TEAM_S4] = { Vector('-958.263611 1908.137817 630') },
			[TEAM_S5] = { Vector('-958.263611 1908.137817 630') },
			[TEAM_ALTER] = { Vector('-958.263611 1908.137817 630') },
			[TEAM_S6] = { Vector('-867.293457 1826.577637 630') },
			[TEAM_S7] = { Vector('-867.293457 1826.577637 630') },
			[TEAM_S8] = { Vector('-867.293457 1826.577637 630') },
			[TEAM_S9] = { Vector('-867.293457 1826.577637 630') },
			[TEAM_COMBINE1] = { Vector('-1036.138794 2301.195068 720') },
			[TEAM_COMBINE2] = { Vector('-1036.138794 2301.195068 720') },
			[TEAM_STATICREBEL] = { Vector('-1036.138794 2301.195068 720') },
			[TEAM_COMBINE3] = { Vector('-1036.138794 2301.195068 720') },
			[TEAM_COMBINE4] = { Vector('-872.479980 2335.560791 700') },
			[TEAM_COMBINE5] = { Vector('-872.479980 2335.560791 700') },
			[TEAM_COMBINE6] = { Vector('-872.479980 2335.560791 700') },
			[TEAM_COMBINE7] = { Vector('-872.479980 2335.560791 700') },
			[TEAM_COMBINE8] = { Vector('-872.479980 2335.560791 700') },
			[TEAM_SYNTH1] = { Vector('-1080.243042 2261.290039 700') },
			[TEAM_SYNTH2] = { Vector('-1080.243042 2261.290039 700') },
			[TEAM_SYNTH3] = { Vector('-1080.243042 2261.290039 700') },
			[TEAM_SYNTH4] = { Vector('-1080.243042 2261.290039 700') },
			[TEAM_SYNTH5] = { Vector('-1080.243042 2261.290039 700') },
			[TEAM_SYNTH6] = { Vector('-1080.243042 2261.290039 700') },
			[TEAM_CITIZEN1] = { Vector('947.396179 2444.477539 736.152100') },
			[TEAM_CITIZEN2] = { Vector('947.396179 2444.477539 736.152100') },
			[TEAM_CITIZEN3] = { Vector('944.009460 2699.444336 733.771851') },
			[TEAM_CITIZEN4] = { Vector('944.009460 2699.444336 733.771851') },
			[TEAM_STALKER] = { Vector('172.429230 2702.436279 599.938416') },
			[TEAM_TRADE] = { Vector('947.396179 2444.477539 736.152100') },
			[TEAM_METH] = { Vector('947.396179 2444.477539 736.152100') },
			[TEAM_VORT] = { Vector('-1830.034058 -388.995209 -1060.968750') },
			[TEAM_CITYWORKER] = { Vector('-574.657227 197.652908 276.031250') },
			[TEAM_CWU1] = { Vector('-591.433350 316.612915 276.031250') },
			[TEAM_CWU3] = { Vector('-591.433350 316.612915 276.031250') },
			[TEAM_CWU4] = { Vector('-574.657227 197.652908 276.031250') },
			[TEAM_R1] = { Vector('-1557.163940 -341.433441 -997.403564') },
			[TEAM_R2] = { Vector('-1557.163940 -341.433441 -997.403564') },
			[TEAM_R3] = { Vector('-1536.686646 -162.884232 -1006.895752') },
			[TEAM_R4] = { Vector('-1536.686646 -162.884232 -1006.895752') },
			[TEAM_R5] = { Vector('-1527.027344 61.694889 -1016.271362') },
			[TEAM_R6] = { Vector('-1527.027344 61.694889 -1016.271362') },
			[TEAM_R7] = { Vector('-1527.911255 -178.012695 -997.611084') },
			[TEAM_R8] = { Vector('-1527.911255 -178.012695 -997.611084') },
			[TEAM_HERO1] = { Vector('-2089.424561 -368.593292 -997.836060') },
			[TEAM_HERO2] = { Vector('-2089.424561 -368.593292 -997.836060') },
			[TEAM_HERO3] = { Vector('-2089.424561 -368.593292 -997.836060') },
			[TEAM_HERO4] = { Vector('-1969.481201 -368.109467 -994.201294') },
			[TEAM_HERO5] = { Vector('-1969.481201 -368.109467 -994.201294') },
			[TEAM_HERO6] = { Vector('-1969.481201 -368.109467 -994.201294') },
			[TEAM_HERO7] = { Vector('-1834.553711 -367.080048 -989.910034') },
			[TEAM_HERO8] = { Vector('-1834.553711 -367.080048 -989.910034') },
			[TEAM_HERO9] = { Vector('-1834.553711 -367.080048 -989.910034') },
			[TEAM_HERO10] = { Vector('-1834.553711 -367.080048 -989.910034') },
			[TEAM_METH] = { Vector('947.396179 2444.477539 736.152100') },
			[TEAM_CRIME] = { Vector('947.396179 2444.477539 736.152100') },
			[TEAM_CRIME2] = { Vector('947.396179 2444.477539 736.152100') },
			[TEAM_CRIME3] = { Vector('947.396179 2444.477539 736.152100') },
			[TEAM_CRIMES] = { Vector('947.396179 2444.477539 736.152100') },
			[TEAM_HITMAN] = { Vector('947.396179 2444.477539 736.152100') },
			[TEAM_CWUWORK1] = { Vector('-591.433350 316.612915 276.031250') },
			[TEAM_CWUVORT2] = { Vector('-591.433350 316.612915 276.031250') },
			[TEAM_CITIZEN] = {
				Vector('2099.231934 3759.884033 647.610657'),
				Vector('2081.636963 4034.826172 645.450623'),
				Vector('2084.332275 4334.808594 645.450623'),
				Vector('2086.286377 4552.294434 645.450623'),
			},
			[TEAM_CITIZEN24] = { Vector('1334.934570 2703.262451 681.269958') }
		}
	}
...
rp.cfg.SpawnPos = {
	rp_city2_v4_finalb = {
		...
		Vector('9400 11150 516.031250'),
		Vector('9500 11150 516.031250'),

		Vector('9100 11050 516.031250'),
		Vector('9200 11050 516.031250'),
		Vector('9300 11050 516.031250'),
		Vector('9400 11050 516.031250'),
		Vector('9500 11050 516.031250'),

		Vector('9100 11250 516.031250'),
		Vector('9200 11250 516.031250'),
		Vector('9300 11250 516.031250'),
		Vector('9400 11250 516.031250'),
		Vector('9500 11250 516.031250'),
	}
}
...
rp.cfg.JailPos = {
	rp_city2_v4_finalb = {
		Vector('-48.895252 2754.387207 524.031250'),
	}
}
rp.cfg.JailPos['rp_downtown_sup_b5c_night'] = rp.cfg.JailPos['rp_city2_v4_finalb']
