...
TEAM_CITIZEN = rp.addTeam('Недавно Прибывший', {
	...
	model = false,
	description = [[
Недавно прибывший в Сити 2 человек, не прошедший проверку и идентификацию на получение CID-карты.
]],
	weapons = {},
...
TEAM_CITIZEN24 = rp.addTeam('Гражданин Сити 2', {
	color = Color(102,153,102),
	model = false,
	description = [[
...
TEAM_CITIZEN4 = rp.addTeam("Администратор Сити 2", {
	color = Color(178, 35, 35),
	model = "models/player/scifi_bill.mdl",
	type = TEAMTYPE_COMBINE,
	description = [[Управляет городом и проводит трансляции связанные с пропагандой из здания администрации Сити 2]],
...
TEAM_CWU4 = rp.addTeam("Надзиратель", {
	...
	description = [[Специальный юнит отдела гражданской обороны Сити 2 следящий за сотрудниками ГСР]],
...
rp.cfg.NPCs = {
	['rp_city2_v4_finalb'] = {
		['reg_npc'] = {
			...
			ang = Angle('8.137796 -129.506714 0.000000'),
		...
		['crime_npc'] = {
			...
			color = Color(255,255,255,255),
			pos = Vector('-967.873901 1865.548462 -30'),
			ang = Angle('10.493989 158.124023 0.000000'),
		...
		['cwu_npc'] = {
			title = 'ГСР',
			color = Color(255,255,255,255),
			pos = Vector('-264.429749 363.499390 430'),
			Ang = Angle('1.267220 -93.348549 0.000000'),
		...
		['loyal_npc'] = {
			...
			Ang = Angle('3.405620 -125.642334 0.000000'),
		...
		['rebel_npc'] = {
			...
			color = Color(255,255,255,255),
			pos = Vector('-2235.956055 435.538177 -1032.968750'),
			ang = Angle('8.038786 10.676935 0.000000'),
		...
		['fake_npc'] = {
			title = 'C#U.#5.43#7',
			color = Color(255,255,255,255),
			pos = Vector('-1989.703491 646.978271 -1030.968750'),
		...
		['hero_npc'] = {
			title = 'Барни Калхаун',
			color = Color(255,255,255,255),
			pos = Vector('-1106.702148 -183.708130 -1030'),
