...
rp.cfg.NPCs = {
	['rp_cyberz_c18_v1'] = {
		...
		['crime_npc'] = {
			...
			color = Color(255,255,255,255),
			pos = Vector('-445.971771 3777.773926 863'),
			ang = Angle('0 -145 0'),
		...
		['rebel_npc'] = {
			...
			color = Color(255,255,255,255),
			pos = Vector('3694.262939 4799.968750 611'),
			ang = Angle('0 -90 0'),
		...
		['fake_npc'] = {
			title = 'C#U.#5.43#7',
			color = Color(255,255,255,255),
			pos = Vector('2142.854004 2799.968750 611.031250'),
			ang = Angle('0 -90 0'),
			model = 'models/Police.mdl',
			jobs = {
				[TEAM_ALTER] = 40000,
		...
		['hero_npc'] = {
			title = 'Барни Калхаун',
			color = Color(255,255,255,255),
			pos = Vector('-2596.248779 3702.876953 611.053162'),
			ang = Angle('0 0 0'),
