...
rp.AddWeapon("Взлом Барьера", "models/props_c17/tools_wrench01a.mdl", "weapon_shieldsbreaker", 200, 10, true, 900, false, {TEAM_R8, TEAM_R11})
rp.AddWeapon("Элитные Сигареты", "models/props_c17/tools_wrench01a.mdl", "weapon_ciga_cheap", 50, 10, false, 900, false, {TEAM_R8, TEAM_R11})
rp.AddWeapon("Заменитель Сигарет", "models/props_c17/tools_wrench01a.mdl", "weapon_ciga_blat", 50, 10, false, 900, false, {TEAM_R8, TEAM_R11})
rp.AddWeapon("Взломщик", "models/props_c17/tools_wrench01a.mdl", "lockpick", 7500, 10, false, 550, false, {TEAM_R8, TEAM_R11})
rp.AddEntity("Батарея Принтера", "boost_battery", "models/props_c17/consolebox05a.mdl", 100, 10, "/buybatt", {TEAM_R8, TEAM_R11}, false)
rp.AddEntity("Охлаждение Принтера", "boost_cooling", "models/props_junk/PropaneCanister001a.mdl", 120, 10, "/buycool35", {TEAM_R8, TEAM_R11}, false)
...
-- Cook
rp.AddFoodItem("Банан", "models/props/cs_italy/bananna.mdl", 10, 10/2, 50)
rp.AddFoodItem("Связка бананов", "models/props/cs_italy/bananna_bunch.mdl", 10, 10/2, 150)
rp.AddFoodItem("Вода", "models/bioshockinfinite/xoffee_mug_closed.mdl", 20, 20/2, 100)
rp.AddFoodItem("Бутылка газировки", "models/props_junk/GlassBottle01a.mdl",20, 20/2, 200)
-- rp.AddFoodItem("Popcan", "models/props_junk/PopCan01a.mdl", 5, 5/2, 100)
rp.AddFoodItem("Бутылка воды", "models/props_junk/garbage_plasticbottle003a.mdl", 15, 15/2, 180)
rp.AddFoodItem("Еда из рациона", "models/foodnhouseholdaaaaa/combirationc.mdl", 30, 30/2, 250)
-- rp.AddFoodItem("Bottle1", "models/props_junk/garbage_glassbottle001a.mdl", 10, 10/2, 100)
-- rp.AddFoodItem("Bottle2", "models/props_junk/garbage_glassbottle002a.mdl", 10, 10/2, 100)
-- rp.AddFoodItem("Bottle3", "models/props_junk/garbage_glassbottle003a.mdl", 10, 10/2, 100)
rp.AddFoodItem("Апельсин", "models/props/cs_italy/orange.mdl",20, 20/2, 30)
-- rp.AddFoodItem("Burger", "models/food/burger.mdl", 50, 50/2, 100)
-- rp.AddFoodItem("Hotdog", "models/food/hotdog.mdl", 45, 45/2, 100)
rp.AddFoodItem("Лапша", "models/props_junk/garbage_takeoutcarton001a.mdl", 40, 40/2, 70)



rp.AddAmmoType("Pistol", "Pistol Ammo", "models/Items/BoxSRounds.mdl", 50, 50, 100)
rp.AddAmmoType("Buckshot", "Shotgun Ammo", "models/Items/BoxBuckshot.mdl", 50, 25, 100)
rp.AddAmmoType("smg1", "SMG Ammo ", "models/Items/BoxSRounds.mdl", 100, 100, 100)
rp.AddAmmoType("Rifle", "Rifle Ammo ", "models/Items/BoxSRounds.mdl", 100, 50, 100)
rp.AddAmmoType("AR2", "Rifle Ammo ", "models/Items/BoxSRounds.mdl", 100, 50, 100)
