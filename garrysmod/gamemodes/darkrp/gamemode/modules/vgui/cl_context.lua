...
local function OpenContextMenu()
	...
	local gps = {
        ['Регистрация в Городе'] = function()
            return Vector('560.270630 3426.633789 692.924316')
        end,
		['Цитадель'] = function()
			return Vector('325.940643 1631.084961 725.916321')
		end,
        ['Почта / Посылки'] = function()
            return Vector('-690.252991 -3052.644775 102.950958')
        end,
        ['Офис ГСР'] = function()
            return Vector('-701.429993 602.857727 685.537109')
        end,
        ['Завод №1'] = function()
        ...
        ['Центр Лояльности'] = function()
            return Vector('773.137878 384.774475 690.205078')
        end,
	}
