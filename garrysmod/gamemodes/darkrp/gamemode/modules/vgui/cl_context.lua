...
local function OpenContextMenu()
	...
	local gps = {
        ['Регистрация в Городе'] = function()
            return Vector('-2798.534424 637.939758 208.031250')
        end,
		['Цитадель'] = function()
			return Vector('1936.252197 -65.550926 150.813980')
		end,
        -- ['Почта / Посылки'] = function()
        --     return Vector('-690.252991 -3052.644775 102.950958')
        -- end,
        ['Офис ГСР'] = function()
            return Vector('-445.024445 1456.311768 222.507019')
        end,
        -- ['Завод №1'] = function()
        --     return Vector('767.648438 -615.009338 142.162018')
        -- end,
        -- ['Завод №2'] = function()
        --     return Vector('-551.430176 -733.310730 84.890099')
        -- end,
        -- ['Завод №3'] = function()
        --     return Vector('-1723.636719 -486.683197 152.934418')
        -- end,
        -- ['Жилой Блок №1'] = function()
        --     return Vector('32.313915 208.912338 129.489349')
        -- end,
        -- ['Жилой Блок №2'] = function()
        --     return Vector('-4139.778809 1453.733154 709.708252')
        -- end,
        -- ['Жилой Блок №3'] = function()
        --     return Vector('600.887634 502.620575 704.282227')
        -- end,
        -- ['Жилой Блок №4'] = function()
        --     return Vector('-148.749649 -3749.722168 127.188789')
        -- end,
        ['Центр Лояльности'] = function()
            return Vector('-149.318649 -1271.938965 127.379715')
        end,
	}
